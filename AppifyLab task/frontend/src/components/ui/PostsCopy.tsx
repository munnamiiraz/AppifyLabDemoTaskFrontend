...
import React4 from "../../assets/images/react_img4.png"
import React5 from "../../assets/images/react_img5.png"
import CommentImg from "../../assets/images/comment_img.png"
import TextImg from "../../assets/images/top_img.png"
    ...
    <div className="_feed_inner_timeline_post_area _b_radious6 _padd_b24 _padd_t24 _mar_b16">
            ...
            <div id="_timeline_drop" className="_feed_timeline_dropdown _timeline_dropdown">
              <ul className="_feed_timeline_dropdown_list">
                <li className="_feed_timeline_dropdown_item">
                  <Link to="#0" className="_feed_timeline_dropdown_link">
                    <span>
      ...
      <div className="_feed_inner_timeline_total_reacts _padd_r24 _padd_l24 _mar_b26">
        <div className="_feed_inner_timeline_total_reacts_image">
          <img src={React1} alt="Image" className="_react_img1" />
          <img src={React2} alt="Image" className="_react_img" />
          <img src={React3} alt="Image" className="_react_img _rect_img_mbl_none" />
          <img src={React4} alt="Image" className="_react_img _rect_img_mbl_none" />
          <img src={React5} alt="Image" className="_react_img _rect_img_mbl_none" />
          <p className="_feed_inner_timeline_total_reacts_para">9+</p>
        </div>
        <div className="_feed_inner_timeline_total_reacts_txt">
          <p className="_feed_inner_timeline_total_reacts_para1">
            <Link to="#0"><span>12</span> Comment</Link>
          </p>
        ...
        <div className="_comment_main">
          <div className="_comment_image">
            <Link to="profile.html" className="_comment_image_link">
              <img src={TextImg} alt="" className="_comment_img1" />
            </Link>
          </div>
